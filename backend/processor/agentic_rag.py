...
class AgenticRAGManager:
    ...
    def process_query(self, query: str):
        ...
        evaluation_prompt = PromptTemplate.from_template("""Review the following query and context. If the context is sufficient to provide a complete and accurate answer, respond with just "YES". 
            ...
            Response (either "YES" or a search query):"""
        )
        ...
        try:
                ...
                web_context = web_results.choices[0].message.content
...
def main():
    ...
    rag_manager.process_query("How does AI Retail Suite compare to Salesforce Einstein and SAP Commerce Cloud for dynamic pricing?")
